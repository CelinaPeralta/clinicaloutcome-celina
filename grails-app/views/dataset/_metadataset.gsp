...
<div id="show-metaDataset" class="content scaffold-show" role="main">
  ...
  <ol class="property-list metaDataset">
    ...
    <g:if test="${metaDatasetInstance?.notes}">
      <li class="fieldcontain">
        <span id="notes-label" class="property-label"><g:message code="metaDataset.notes.label" default="Notes" /></span>
        <span class="property-value" aria-labelledby="notes-label"><g:fieldValue bean="${metaDatasetInstance}" field="notes"/></span>
      </li>
    </g:if>
